                            ...
                            @foreach($archives as $archive)
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading{{ $archive->id }}">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{ $archive->id }}" aria-expanded="false" aria-controls="collapse{{ $archive->id }}">
                                            {{ $archive->titre }}
                                        </button>
                                    </h2>
                                    <div id="collapse{{ $archive->id }}" class="accordion-collapse collapse" aria-labelledby="heading{{ $archive->id }}" data-bs-parent="#accordionSunnah">
