...
<div class="blog-post-area pt-100 pb-100">
    <div class="container">
        <div class="section-title">
            <span class="top-title">أخبار تونسية داعمة لفلسطين</span>
            <h2>تابع آخر المواقف والتصريحات التونسية</h2>
        </div>
        <div class="row">
            <div class="col-lg-8">
                <div class="single-blog-post-content">
                    <div class="row">
                        @forelse($newsTunisia as $news)
                        ...
                        @empty
                            <div class="col-12">
                                <p class="text-center">لا توجد أخبار حالياً ضمن هذه الفئة.</p>
                            </div>
                        @endforelse
                    </div>
            ...
            <div class="col-lg-4">
                <div class="blog-post-right-bar">
                    <div class="blog-post-search">
                        <form class="search-form" method="GET" action="{{ route('celebrities') }}">
                            <input type="text" name="query" class="form-control" placeholder="ابحث هنا" value="{{ request('query') }}">
                            <button type="submit" class="default-btn">
                                <i class='bx bx-search'></i>
                            </button>
                        </form>
                        @if($newsTunisia->isEmpty() && request('query'))
                            <div class="col-12">
                                <p class="text-center mt-3">لا توجد نتائج مطابقة للبحث.</p>
                            </div>
                        @endif
                    </div>
